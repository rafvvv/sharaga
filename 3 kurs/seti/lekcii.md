...
Описание: наиболее простой тип коммутаторов, представляющий собой отдельный корпус со всеми необходимыми элементами, количество и тип портов обычно фиксированы.
...
Количество портов, Тип портов, Пропускная способность, lvl надежности, Функциональность, Управление
